...
export default function Contact() {
  return (
    <section id="contact" className="scroll-reveal py-20 sm:py-28 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="grid sm:grid-cols-2 gap-8 text-left">
          <a
            ...
            className="flex items-center gap-4 p-6 rounded-2xl bg-[#F5E1E6]/30 hover:bg-[#F5E1E6]/50 transition-colors"
          >
            <div className="w-12 h-12 rounded-full bg-[#E91E8C]/10 flex items-center justify-center">
      ...
      <a
        href={`${WHATSAPP}?text=Hi%2C%20I'd%20like%20to%20book%20an%20appointment%20at%20Abbyz%20Beautyy`}
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-green-500 rounded-full flex items-center justify-center shadow-lg hover:scale-110 hover:shadow-xl transition-all duration-300"
